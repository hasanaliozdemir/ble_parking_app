              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Icon(CupertinoIcons.slider_horizontal_3,color: blue500,),
                  )
                ],
              ))
        ],
...
List<Park> parks = [
  ...
  Park(
      "OttoSocialHouse", LatLng(40.357235, 27.971058), 18, Status.owner, false),
];
...
List<Widget> markerWidgets() {
  return parks
      .map((c) =>
          _getMarkerWidget(c.price.toString(), c.status, c.isWeithElectricity))
      .toList();
}
